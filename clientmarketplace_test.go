...
func TestClientMarketplaceNewAgentWithOptionalParams(t *testing.T) {
	...
	_, err := client.Client.Marketplace.NewAgent(context.TODO(), swarms.ClientMarketplaceNewAgentParams{
		NumberOfItems: swarms.Int(0),
	})
	if err != nil {
