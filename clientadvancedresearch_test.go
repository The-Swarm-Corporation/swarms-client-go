...
func TestClientAdvancedResearchNewCompletionWithOptionalParams(t *testing.T) {
	...
	_, err := client.Client.AdvancedResearch.NewCompletion(context.TODO(), swarms.ClientAdvancedResearchNewCompletionParams{
